...
if __name__ == '__main__':
    ...
    #datapath = 'FB.csv'
    # Create a Data Feed
    #data = bt.feeds.YahooFinanceCSVData( dataname=datapath, fromdate=datetime.datetime(2013, 1, 1),todate=datetime.datetime(2018, 8, 5),reverse=True)
    # Download data from Yahoo Finance
    data = get_df_from_yf('TCS', '2023-01-01', '2024-02-31')
